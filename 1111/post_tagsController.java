...
public class post_tagsController {
    ...
    public ResponseEntity<Void> addTagsToPost(@PathVariable("post_id") int postId, @RequestBody List<tags> tags) {
        int rowsInserted = postTagsMapper.addTagsToPost(postId, tags);
        if (rowsInserted > 0) {
